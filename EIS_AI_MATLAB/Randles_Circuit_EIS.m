...
%% 1. Исходные параметры схемы Рэндлса для ячейки Li-ion 18650 (NMC, ~3 Ач)
Rs  = 0.018;      % Омическое сопротивление электролита и контактов (Ом)
Rct = 0.022;      % Сопротивление переносу заряда на аноде/катоде (Ом)
Cdl = 2.5;        % Емкость двойного электрического слоя (Фарад)
Aw  = 0.008;      % Коэффициент Варбурга для диффузии лития (Ом * c^-0.5)
