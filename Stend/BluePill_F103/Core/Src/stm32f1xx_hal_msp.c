...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  if(huart->Instance==USART1)
  {
    ...
    PB7     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = DDS_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(DDS_TX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = DDS_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(DDS_RX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART1)
  {
    ...
    PB7     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOB, DDS_TX_Pin|DDS_RX_Pin);
  ...
  else if(huart->Instance==USART3)
  {
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, LOG_TX_Pin|LOG_RX_Pin);
